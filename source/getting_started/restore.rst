...
*  chmod + x cclpbx-restore.sh and then run the script ./fusionpbx-restore.sh
...
::
 ...
 pg_restore -v -Fc --host=$database_host --port=$database_port --dbname=cclpbx --username=cclpbx /var/backups/fusionpbx/postgresql/fusionpbx_pgsql_$now.sql
