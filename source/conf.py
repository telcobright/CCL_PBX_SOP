# -*- coding: utf-8 -*-
#
# cclpbx Docs documentation build configuration file, created by
...
# of the sidebar.
#html_logo = "_static/imagesccllogo.png"
...
latex_documents = [
  ('index', 'cclpbxDocs.tex', u'cclpbx Documentation',
...
man_pages = [
    ('index', 'cclpbxdocs', u'cclpbx Documentation',
...
texinfo_documents = [
  ('index', 'cclpbxDocs', u'cclpbx Documentation',
   u'Mark J Crane & Len Graham', 'cclpbxDocs', 'One line description of project.',
   'Miscellaneous'),
]
