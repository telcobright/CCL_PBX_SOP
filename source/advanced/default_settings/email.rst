...
*  `SMTP2GO <http://docs.cclpbx.com/en/latest/advanced/default_settings/smtp2go.html>`_
*  `GMAIL <http://docs.cclpbx.com/en/latest/advanced/default_settings/gmail.html>`_
...
* `Email Log <http://docs.cclpbx.com/en/latest/advanced/default_settings/email_error_log.rst>`_
